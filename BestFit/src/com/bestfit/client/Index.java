				...
				if (result.IsloggedIN) {
					...
					SaveButton.addClickHandler(new ClickHandler() {
						...
						public void onClick(ClickEvent event) {
							...
							registreNewysers.firstName = FirstNameTextBox
									.getText();
							registreNewysers.lastName = LastNameTextBox
									.getText();
							registreNewysers.email = EmailAddressTextBox
									.getText();
							registreNewysers.gender = comboBox
									.getItemText(comboBox.getSelectedIndex());
							registreNewysers.height = Double
									.valueOf(HeightTextBox.getText());
							registreNewysers.weight = Double
									.valueOf(WeightTextBox.getText());
							registreNewysers.age = integerBox.getValue();

							rpc.registerUser(registreNewysers,
